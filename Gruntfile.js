...
module.exports = function(grunt) {
                ...
                options: {
                    ...
                    middleware: function(connect, options, middlewares) {
                        return [
                            ...
                            connect().use('/Backbone-CLI', connect.static('dist')),
                            connect.static('libs')
                        ].concat(middlewares);
                    }
                }
                ...
                options: {
                    ...
                    modules: [{
                        ...
                        include: [
                            ...
                            'helpers/pop-view',
                            /*'vendor/jquery.printarea',
                            'vendor/jquery-barcode',*/
                            'templates/main',
                            'templates/home',
                            'home'
                        ],
    ...
    grunt.registerTask('createDefaultTemplate', function () {
        grunt.file.write('.tmp/scripts/templates.js', 'define([], function() {return this.reportTemplates = this.reportTemplates || {};})');
    });
