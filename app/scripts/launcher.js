...
(function (document) {
    ...
    require.config({
        ...
        paths: {
            ...
            'bootstrap-treeview': 'http://'+cdnBasePath+'/jslib/bootstrap-treeview/dist/bootstrap-treeview.min',
            'jquery-qrcode': 'http://'+cdnBasePath+'/jslib/jquery-qrcode/jquery.qrcode.min',
        },
        shim: {
            bootstrap: {
                deps: ['jquery']
