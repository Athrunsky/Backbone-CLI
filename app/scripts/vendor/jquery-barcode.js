...
(function (b) {
    var a = {
        ...
        digitToCssRenderer: function (q, d, m, e, p, g) {
            ...
            if (d.showHRI) {
                j += '<div style="clear:both; width: 100%; background-color: ' + d.bgColor + "; color: " + d.color + "; text-align: center; font-size: " + d.fontSize +d.fontType+";"+(d.fontFamily ? ("font-family: "+d.fontFamily+";") : "")+(d.letterSpacing ? ("letter-spacing: "+d.letterSpacing+";") : "")+" font-weight: "+d.fontWeight+"; margin-top: " + d.marginHRI + 'px;">' + e + "</div>"
            }
