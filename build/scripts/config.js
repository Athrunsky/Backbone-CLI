...
require.config({
    paths: {
        ...
        //vendor
        'bootstrap-datetimepicker': '/libs/bootstrap-datetimepicker/bootstrap-datetimepicker4',
        'bootstrap-pagination' : '/libs/bootstrap-pagination/bootstrap-pagination',
        ...
        // end
        'dropzone': '/libs/dropzone/dropzone-amd-module.min',

        'numeral': '../../bower_components/numeral/numeral',
        // editor
        'bootstrap.wysihtml5': '/libs/bootstrap-wysihtml5/bootstrap.wysihtml5.min',
        'bootstrap.wysihtml5.templates': '/libs/bootstrap-wysihtml5/bootstrap.wysihtml5.templates.min',
        'bootstrap.wysihtml5.commands': '/libs/bootstrap-wysihtml5/bootstrap.wysihtml5.commands.min',
        'wysihtml5': '/libs/bootstrap-wysihtml5/wysihtml5.min',
        'rangy': '../../bower_components/rangy/rangy-core',
        'rangy-selectionsaverestore': '../../bower_components/rangy/rangy-selectionsaverestore',

        'jquery-select2': '/libs/jquery-select2/jquery-select2.min',
        'socket.io': '../../bower_components/socket.io/index',
        'echarts': '../../bower_components/echarts/echarts',
        'echarts-map-china': '../../bower_components/echarts/map/china',
        ...
        'jquery.printarea': 'vendor/jquery.printarea',
        'jquery-vendor': 'vendor/jquery-vendor',
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
